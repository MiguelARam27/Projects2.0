...
const equallyStrong =(yourLeft,yourRight,friendLeft,friendRight) =>{
    
    let yourSum = yourLeft + yourRight;
    let friendSum = friendLeft + friendRight; 

    return yourSum === friendSum;
}


console.log(equallyStrong(15,10,20,5))